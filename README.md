...
* https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.3.6/app/models/ci/build.rb
* https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.3.6/lib/gitlab/ci/jwt.rb
* https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.3.6/app/controllers/jwt_controller.rb
* JWKS (JSON Web Key Set) endpoint (e.g. https://gitlab.example.com/-/jwks) at https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.3.6/config/routes.rb#L177-180
